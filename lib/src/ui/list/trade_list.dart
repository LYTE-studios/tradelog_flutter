        ...
        children: [
          SingleChildScrollView(
            ...
            child: ConstrainedBox(
              ...
              // Add bottom padding to ensure the content doesn't get hidden under the PaginationWidget.
              child: Padding(
                      ...
                      rows: paginatedTrades.asMap().entries.map((entry) {
                        ...
                        final rowItems = [
                          ...
                          Checkbox(
                            ...
                            onChanged: (value) {
                              setState(() {
                                _selected[(_currentPage - 1) * _pageSize +
                                    index] = value!;
          ...
          // Lock PaginationWidget to the bottom of the viewport.
          Positioned(
            left: 0,
            right: 0,
            bottom: 0,

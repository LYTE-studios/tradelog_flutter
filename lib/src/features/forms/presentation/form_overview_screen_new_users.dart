...
import 'package:tradelog_flutter/src/features/forms/presentation/onboard_user_dialog_mobile.dart';
import 'package:tradelog_flutter/src/features/forms/presentation/profit_loss_loop_row.dart';
import 'package:tradelog_flutter/src/ui/buttons/copy_link_button_secondary.dart';
import 'package:tradelog_flutter/src/ui/icons/tradely_icons.dart';
import 'package:tradelog_flutter/src/ui/theme/padding_sizes.dart';

class FormOverviewScreenNewUsers extends StatefulWidget {
  static const String route = '/$location';
  static const String location = 'forms';

  const FormOverviewScreenNewUsers({super.key});

  @override
  State<FormOverviewScreenNewUsers> createState() => _FormOverviewScreenState();
}

class _FormOverviewScreenState extends State<FormOverviewScreenNewUsers>
                  ...
                  child: SizedBox(
                    ...
                    child: Center(
                      child: GestureDetector(
                        onTap: () => OnboardUserDialogMobile.show(context),
                ...
                Positioned(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        '3488 others shared their progress',
